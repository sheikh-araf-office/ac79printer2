...
This function is called when the event handling functions of all active apps return false
*/
...
void app_main()
{
    ...
    it.name	= "net_video_rec";// APP state machine is located in: net_video_rec.c
#ifdef CONFIG_UI_ENABLE
    ...
    //prodct_auto_test_task_create();// Automatic mass production test: testing front and rear cameras
}

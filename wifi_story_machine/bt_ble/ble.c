...
static const struct ble_client_operation_t *ble_client_api;
    // Alke @20230726 WifiPrinter-ID mac 改变名字 这里似乎没有起作用
//static const u8 test_remoter_name1[] = "JL-AC79XX-AF0B(BLE)";//k
static const u8 test_remoter_name1[] = "Wifi-JL-Printer-AF0B(BLE)";//

...
static void bredr_handle_register(void)
{
    ...
    printf("sang:bredr_handle_register\n");
...
static void bt_function_select_init(void)
{
    ...
    __change_hci_class_type(0x40680);
...
{
    printf("-----------------------bt_connction_status_event_handler %d\n", bt->event);
    ...
    case BT_STATUS_INIT_OK:
         ...
         * 蓝牙初始化完成
         */
        printf("sang:BT_STATUS_INIT_OK--BT initialize\n");
#if SPP_TRANS_DATA_EN
    printf("sang:transport_spp_init\n");
    ...
    case BT_STATUS_START_CONNECTED:
        printf(" BT_STATUS_START_CONNECTED----------------\n");
        break;
    case BT_STATUS_ENCRY_COMPLETE:
        printf(" BT_STATUS_ENCRY_COMPLETE\n");
        break;

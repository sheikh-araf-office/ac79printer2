...
// Alke @20230730 PID & VID
    u8 sDeviceDescriptor[] = { //<Device Descriptor
...
#error "USB_SPEED_MODE not defined"
    ...
    0x86, 0x1A,     // idVendor: 0x4a4c - JL
    0x08, 0x15, // 0x32, 0xC2,     //0x08, 0x15, // Alke @20230730 0x32, 0xC2,     // idProduct: chip id

...
//printf("BI1");
		...
		{
//printf("CMP");
			if(	(!CRGRunning)&&((PaperState==sPaperFrontNormal)||(PaperState==sPaperBackNormal)) &&
...
//printf("0-%d-%d", CRGNowTimePosition, CRGStopTimePosition);
		...
		if(CRGNowTimePosition == CRGStopTimePosition)
		{
			if(	(!PAPRunning)&&((PaperState==sPaperFrontNormal)||(PaperState==sPaperFrontNormal)) &&
			...
			{
//printf("1-%d-%d-%d-%d-%d", BufferPrint[cBufferPrintLineRead].cLeft, BufferPrint[cBufferPrintLineRead].cRight, CRGNowTimePosition, CRGStopTimePosition, BufferPrint[cBufferPrintLineRead].Step);

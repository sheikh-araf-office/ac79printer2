...
// 0x1B 0X0B 0X03 IP"192.168.43.2" 0X0A // 3 WIFI_EVENT_STA_NETWORK_STACK_DHCP_SUCC就是上面的3状态，即获得了IP地址，USB设置网络完成，后面旧切换到WIFI通讯
// 0x1B 0X0B 0X04 WIFI READY! 0X0A
// 0x1B 0X0B 0X05 Mode&PID&IP&MCUID&Prnter 0X0A

// 6 WIFI_EVENT_STA_CONNECT_TIMEOUT_NOT_FOUND_SSID
// 7 WIFI_EVENT_STA_CONNECT_ASSOCIAT_FAIL
// 8 WIFI_EVENT_STA_CONNECT_ASSOCIAT_TIMEOUT
// 9 WIFI_EVENT_STA_NETWORK_STACK_DHCP_TIMEOUT

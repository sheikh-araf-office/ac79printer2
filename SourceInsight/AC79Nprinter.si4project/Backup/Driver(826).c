...
//printf("30-\n");
		...
		BufferPrint[cBufferPrintLineWrite].cLeft += CRGVolatileStep*CRGOneStepTimePosition;
		BufferPrint[cBufferPrintLineWrite].cLeft -= BufferPrint[cBufferPrintLineWrite].cLeft%CRGOneStepTimePosition;			// adjust to th 16*n
		BufferPrint[cBufferPrintLineWrite].cRight += CRGVolatileStep*CRGOneStepTimePosition;
...
//printf("30--\n");
//CRGNowTimePosition = CRGStopTimePosition;
printf("N%d-S%d\n", CRGNowTimePosition, CRGStopTimePosition);	

...
enum {sINIT, sStartCRGMotor, sWaitingCRGMotor, sStartPAPMotor, sWaitingPAPMotor};
...
enum {sPaperNo, sPaperFrontInit, sPaperFrontNormal, sPaperFrontEnd, sPaperBackInit, sPaperBackNormal, sPaperBackEnd,};

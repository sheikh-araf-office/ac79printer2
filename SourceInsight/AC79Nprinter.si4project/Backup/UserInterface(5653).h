...
#define StepToCutPos		200	// 只有前边有撕纸口
...
enum {sPaperNo = 0, sPaperFrontInit, sPaperFrontNormal, sPaperFrontEnd, sPaperBackNo, sPaperBackInit, sPaperBackNormal, sPaperBackEnd, sPaperBackHead, sPaperErr};

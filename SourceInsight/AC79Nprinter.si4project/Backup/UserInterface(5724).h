...
#define StepBackToPrint		350 // 还需要进一步测量数据
#define StepHeadWide		50 // 还需要进一步测量数据
extern unsigned short PaperCount;
extern volatile unsigned short  PaperState;
enum {sPaperNo = 0, sPaperFrontInit, sPaperFrontNormal, sPaperFrontEnd, sPaperBackInit, sPaperBackNormal, sPaperBackEnd, sPaperBackHead, sPaperErr};
